# Generated by Django 4.2.7 on 2025-09-07 06:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='campaign',
            name='advanced_scheduling_config',
            field=models.JSONField(blank=True, default=dict, help_text='Configuration for advanced scheduling intervals'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='enable_advanced_scheduling',
            field=models.BooleanField(default=False, help_text='Enable multi-channel communication intervals'),
        ),
