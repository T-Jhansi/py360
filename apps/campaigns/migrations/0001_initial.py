# Generated by Django 4.2.7 on 2025-07-24 07:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('uploads', '0006_alter_fileupload_processing_result'),
        ('templates', '__first__'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback', to='campaigns.campaign')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_objects', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campaign_template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='automations', to='campaigns.campaign')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_objects', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_objects', to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.AddField(
            model_name='campaign',
            name='upload',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='campaigns', to='uploads.fileupload'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_objects', to=settings.AUTH_USER_MODEL)),
                ('policy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='campaign_recipients', to='policies.policy')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_objects', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'campaign_recipients',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['campaign', 'email_status'], name='campaign_re_campaig_2298f4_idx'), models.Index(fields=['campaign', 'whatsapp_status'], name='campaign_re_campaig_6f6740_idx'), models.Index(fields=['campaign', 'sms_status'], name='campaign_re_campaig_684ad6_idx'), models.Index(fields=['campaign', 'has_responded'], name='campaign_re_campaig_a2b399_idx'), models.Index(fields=['campaign', 'conversion_achieved'], name='campaign_re_campaig_6b7b2f_idx'), models.Index(fields=['email_status', 'email_sent_at'], name='campaign_re_email_s_3343b2_idx'), models.Index(fields=['customer', 'campaign'], name='campaign_re_custome_6ee88c_idx'), models.Index(fields=['response_type', 'response_received_at'], name='campaign_re_respons_71383e_idx')],
