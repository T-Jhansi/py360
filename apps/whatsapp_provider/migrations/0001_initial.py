# Generated by Django 4.2.7 on 2025-10-08 11:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Friendly name for this WABA account', max_length=100)),
                ('waba_id', models.CharField(help_text='WhatsApp Business Account ID from Meta', max_length=50, unique=True)),
                ('meta_business_account_id', models.CharField(help_text='Meta Business Account ID', max_length=50)),
                ('app_id', models.CharField(blank=True, help_text='Meta App ID (optional)', max_length=50, null=True)),
                ('app_secret', models.TextField(blank=True, help_text='Meta App Secret (encrypted)', null=True)),
                ...
                ('status', models.CharField(choices=[('pending', 'Pending Verification'), ('verified', 'Verified'), ('suspended', 'Suspended'), ('disabled', 'Disabled')], default='pending', max_length=20)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_whatsapp_accounts', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_whatsapp_accounts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waba_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='received_webhook_events', to='whatsapp_provider.whatsappbusinessaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waba_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phone_numbers', to='whatsapp_provider.whatsappbusinessaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('en', 'English'), ('hi', 'Hindi'), ('es', 'Spanish'), ('fr', 'French'), ('de', 'German'), ('pt', 'Portuguese'), ('ar', 'Arabic'), ('zh', 'Chinese'), ('ja', 'Japanese'), ('ko', 'Korean')], default='en', max_length=10)),
                ...
                ('waba_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='message_templates', to='whatsapp_provider.whatsappbusinessaccount')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='phone_number',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='whatsapp_provider.whatsappphonenumber'),
        ),
        migrations.AddField(
            model_name='whatsappmessage',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='messages', to='whatsapp_provider.whatsappmessagetemplate'),
        ),
        migrations.AddField(
            model_name='whatsappmessage',
            name='waba_account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='whatsapp_provider.whatsappbusinessaccount'),
        ),
        migrations.CreateModel(
            name='WhatsAppFlow',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('waba_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flows', to='whatsapp_provider.whatsappbusinessaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waba_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='health_logs', to='whatsapp_provider.whatsappbusinessaccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('waba_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usage_logs', to='whatsapp_provider.whatsappbusinessaccount')),
            ],
            options={
